...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'relation_engine_bulk_update'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from relation_engine_bulk_update.relation_engine_bulk_updateImpl import relation_engine_bulk_update  # noqa @IgnorePep8
impl_relation_engine_bulk_update = relation_engine_bulk_update(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'relation_engine_bulk_update'
        ...
        self.rpc_service.add(impl_relation_engine_bulk_update.update_type_collections,
